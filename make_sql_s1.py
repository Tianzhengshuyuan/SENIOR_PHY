        ...
        with pdfplumber.open(pdf_path) as pdf:
            for chapter_index, chapter in enumerate(chapters):
                ...
                sql_file.write(
                    ...
                    f"VALUES \n"
                    f"('{chapter_id}', 'PHYSICS', 'SENIOR', 'TERM_1', "
                ...
                for section_index, section in enumerate(chapter["sections"]):
                    ...
                    sql_file.write(
                        f"('{section_id}', 'PHYSICS', 'SENIOR', 'TERM_1', "
                    ...
                    for page_number in range(start_page, end_page + 1):
                        ...
                        while char_index < len(current_page.chars):
                            ...
                            # 检查字体和大小是否符合知识点标题的条件
                            if char.get("fontname") == "GZSQUC+FZLTZHK--GBK1-0" and round(char.get("size")) == 14 and char.get("text") != "问" and char.get("text") != "题":
                                ...
                                for next_char_index in range(char_index + 1, len(current_page.chars)):
                                    ...
                                    if next_char.get("fontname") == "GZSQUC+FZLTZHK--GBK1-0" and round(next_char.get("size")) == 14:
                                ...
                                previous_font = "GZSQUC+FZLTZHK--GBK1-0"
                                previous_size = 14
                            # 检查知识点中的正文，是否符合条件
                                ...
                                # 如果遇到句子结束符，结束当前句子
                                if text in "。！？":
                                    proportion = calculate_font_proportion(current_sentence, "AXVVOO+FZSSK--GBK1-0", 12)
...
# 示例用法
pdf_path = "senior_physics_textbooks/senior_1.pdf"  # 替换为你的 PDF 文件路径
output_sql_path = "sql/s1.sql"
